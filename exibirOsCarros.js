    ...
    listaDeCarros.forEach(carro => {
        ...
        <div class="carro w-56 m-1 mb-10">
                        ...
                        <div class="flex">
                            ...
                            <div>
                                <h3 class="ml-4 uppercase mb-1 text-base font-archivo font-bold text-color2">${carro.nome}
                                </h3>
                                ...
                                <h4 class="ml-4 mb-4 font-archivo text-sm capitalize">${carro.cidade} - <span class="uppercase">${carro.estado}</span></h4>
                                <button
